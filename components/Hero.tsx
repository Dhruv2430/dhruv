    ...
    >
      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col z-10 pt-10 lg:pt-0">
          <p className="hero-intro-text text-primary font-mono text-sm tracking-[0.2em] uppercase mb-6">
            DHRUV PANCHAL &mdash; PORTFOLIO
          </p>
          
          {/* Massive Headline */}
          <h1 className="hero-headline font-display text-[var(--text-display-2)] leading-[0.9] tracking-[-0.03em] text-foreground mb-8 perspective-1000">
            <div className="overflow-hidden pb-2"><span className="word inline-block origin-bottom">Building</span></div>
            <div className="overflow-hidden pb-2"><span className="word inline-block origin-bottom">Scalable</span></div>
            <div className="overflow-hidden pb-2 text-primary/90 italic pr-4"><span className="word inline-block origin-bottom">Cloud</span></div>
            <div className="overflow-hidden pb-2"><span className="word inline-block origin-bottom">Systems.</span></div>
          </h1>
          
          <div className="hero-desc flex flex-col md:flex-row gap-6 md:items-center border-l-2 border-primary/30 pl-6 mb-12">
            <p className="max-w-[400px] text-lg text-text-muted leading-relaxed font-sans">
              Full-stack developer focused on performance, clean architecture, and modern infrastructure.
            </p>
          </div>
        ...
        <div className="lg:col-span-5 relative h-full min-h-[400px] hidden md:flex flex-col justify-center border-l border-border/40 pl-12">
          
          {/* Vertical Text */}
          <div className="hero-right-element absolute right-0 top-1/4 -rotate-90 origin-right translate-x-full text-xs font-mono tracking-[0.5em] text-text-muted opacity-50 uppercase">
          ...
          <div className="relative w-full aspect-square max-w-[400px] mx-auto">
            {/* Layer 1: Frame */}
            <div className="hero-right-element parallax-layer-3 absolute inset-8 border border-border/50 rounded-full" />
            
            {/* Layer 2: Glass Card */}
            <div className="hero-right-element parallax-layer-2 absolute inset-12 bg-surface/20 backdrop-blur-md rounded-3xl border border-white/20 flex flex-col items-start justify-end p-8 shadow-2xl">
               <div className="text-xs font-mono text-primary mb-2">01 // AWS</div>
               <div className="font-display text-2xl">Serverless</div>
               <div className="w-12 h-[1px] bg-foreground/20 mt-4" />
            </div>

            {/* Layer 3: Accent Element */}
            <div className="hero-right-element parallax-layer-1 absolute top-0 right-10 w-24 h-24 bg-primary text-button-text rounded-full flex items-center justify-center shadow-lg shadow-primary/20">
               <span className="font-mono text-xs tracking-widest rotate-12">REACT</span>
            </div>
