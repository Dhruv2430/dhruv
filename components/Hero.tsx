        ...
        <div className="lg:col-span-5 relative h-full min-h-[400px] flex flex-col justify-center lg:border-l border-border/40 lg:pl-12 mt-12 lg:mt-0">
          ...
          <div className="relative w-full aspect-square max-w-[400px] mx-auto">
            ...
            >
              ...
              >
                 <div className="text-xs font-mono text-text-muted mb-2">02 // NEXT.JS</div>
                 <div className="font-display text-xl">Full-Stack</div>
            ...
            >
              ...
              >
                 <div className="text-xs font-mono text-background/80 mb-2">03 // GSAP</div>
                 <div className="font-display text-lg">Motion UI</div>
            ...
            <div className="hero-right-element parallax-layer-2 absolute bottom-1/4 -right-6 w-24 h-24 border border-primary/30 rounded-full flex items-center justify-center z-0">
               <span className="font-mono text-[10px] tracking-widest text-text-muted opacity-50 rotate-90">SYSTEMS</span>
            </div>
